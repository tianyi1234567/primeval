...
@OnlyIn(Dist.CLIENT)
public class HuanyingRender<T extends HuanyingEnity> extends EntityRenderer<T> {
        private static final ResourceLocation TEXTURE = Primeval.prefix("model/util/big_drive.png");
        private static final ResourceLocation MODEL = Primeval.prefix("model/util/huanying.obj");
        ...
        public HuanyingRender(EntityRendererProvider.Context context) {
            super(context);
        }
        ...
        public void render(T entity, float entityYaw, float partialTicks, PoseStack matrixStack, @NotNull MultiBufferSource bufferIn,
            ...
            try (MSAutoCloser ignored = MSAutoCloser.pushMatrix(matrixStack)) {
                ...
                BladeRenderState.renderOverridedLuminous(ItemStack.EMPTY, model, "huanying", TEXTURE, matrixStack, bufferIn,
                        packedLightIn);
            }
        }
    }
