...
@OnlyIn(Dist.CLIENT)
public class SuperdriveRenderer<T extends SuperdriveEntity> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURE = Primeval.prefix("model/util/super_drive.png");
    private static final ResourceLocation MODEL = Primeval.prefix("model/util/super_drive.obj");
    ...
    public SuperdriveRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
