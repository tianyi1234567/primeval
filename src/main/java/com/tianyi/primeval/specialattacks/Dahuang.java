...
public class Dahuang extends EntityAbstractSummonedSword
{
    ...
    public Dahuang(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
...
//                ss.setSpeed(speed);
                ...
                double xOffset = random.nextDouble() * 4 * (isRight ? 3.5 : -3.5);
                double yOffset = random.nextFloat() * 5 * (isRight ? 5 : 2);
