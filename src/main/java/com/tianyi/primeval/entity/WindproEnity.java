...
public class WindproEnity extends EntityAbstractSummonedSword
{
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(WindproEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(WindproEnity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(WindproEnity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public WindproEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static WindproEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new WindproEnity(PLEntiteRegristrys.wd, worldIn);
    }
