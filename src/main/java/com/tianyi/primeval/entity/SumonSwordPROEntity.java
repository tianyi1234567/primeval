...
public class SumonSwordPROEntity extends EntityAbstractSummonedSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(SumonSwordPROEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(SumonSwordPROEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(SumonSwordPROEntity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;


    public SumonSwordPROEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static SumonSwordPROEntity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new SumonSwordPROEntity(PLEntiteRegristrys.sp, worldIn);
    }
