...
public class YingYuEnity extends EntityAbstractSummonedSword
{
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(YingYuEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(YingYuEnity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(YingYuEnity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public YingYuEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static YingYuEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new YingYuEnity(PLEntiteRegristrys.wd, worldIn);
    }
