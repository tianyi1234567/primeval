...
public class ChiBangEnity extends EntityAbstractSummonedSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(ChiBangEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(ChiBangEnity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(ChiBangEnity.class, EntityDataSerializers.VECTOR3);

    public ChiBangEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static ChiBangEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new ChiBangEnity(PLEntiteRegristrys.cbsd, worldIn);
    }
