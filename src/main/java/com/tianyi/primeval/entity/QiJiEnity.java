...
public class QiJiEnity extends EntityAbstractSummonedSword
{
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(QiJiEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(QiJiEnity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(QiJiEnity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public QiJiEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static QiJiEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new QiJiEnity(PLEntiteRegristrys.wd, worldIn);
    }
