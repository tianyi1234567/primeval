...
public class ZhesheiEnity extends EntityAbstractSummonedSword
{
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(ZhesheiEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(ZhesheiEnity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(ZhesheiEnity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public ZhesheiEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static ZhesheiEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new ZhesheiEnity(PLEntiteRegristrys.wd, worldIn);
    }
