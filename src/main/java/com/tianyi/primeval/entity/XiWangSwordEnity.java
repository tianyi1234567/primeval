...
public class XiWangSwordEnity extends EntityAbstractSummonedSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(XiWangSwordEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(XiWangSwordEnity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(XiWangSwordEnity.class, EntityDataSerializers.VECTOR3);

    public XiWangSwordEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static XiWangSwordEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new XiWangSwordEnity(PLEntiteRegristrys.xysd, worldIn);
    }
    ...
    protected void onHitEntity(EntityHitResult result)
    {
        ...
        if (targetEntity instanceof LivingEntity lv) {
            KnockBacks.cancel.action.accept(lv);
