...
public class HuanRenEnity extends EntityAbstractSummonedSword
{
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(HuanRenEnity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(HuanRenEnity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(HuanRenEnity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public HuanRenEnity(EntityType<? extends Projectile> entityTypeIn, Level worldIn)
    {
    ...
    public static HuanRenEnity createInstance(PlayMessages.SpawnEntity packet, Level worldIn)
    {
        return new HuanRenEnity(PLEntiteRegristrys.wd, worldIn);
    }
